...
export const courses: Course[] = [
  ...
  { id: 'b-3', owner: 'bob', title: '\u6570\u636e\u5e93\u539f\u7406', classroom: '\u6559\u5b66\u697c303', day: 1, startTime: '13:30', endTime: '15:20', weekPattern: 'even', icon: 'database' },
  ...
  { id: 'b-7', owner: 'bob', title: '\u82f1\u8bed\u53e3\u8bed', classroom: '\u6559\u5b66\u697c404', day: 4, startTime: '18:30', endTime: '19:50', weekPattern: 'all', icon: 'language' },
  ...
  { id: 'b-9', owner: 'bob', title: '\u521b\u4e1a\u57fa\u7840', classroom: '\u901a\u8bc6\u697c102', day: 6, startTime: '08:10', endTime: '10:00', weekPattern: 'all', icon: 'lightbulb' },
  { id: 'a-10', owner: 'alice', title: '\u56e2\u961f\u5408\u4f5c\u8bad\u7ec3', classroom: '\u901a\u8bc6\u697c104', day: 6, startTime: '13:30', endTime: '15:20', weekPattern: 'all', icon: 'users' },
  { id: 'b-10', owner: 'bob', title: '\u5f62\u52bf\u4e0e\u653f\u7b56', classroom: '\u901a\u8bc6\u697c105', day: 6, startTime: '15:40', endTime: '17:10', weekPattern: 'all', icon: 'file-text' },
  { id: 'b-11', owner: 'bob', title: '\u8db3\u7403', classroom: '\u4f53\u80b2\u573a', day: 5, startTime: '15:40', endTime: '17:10', weekPattern: 'odd', icon: 'circle' },
]
